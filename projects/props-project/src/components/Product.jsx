...
export const Product = () => {
    ...
    return (
        <>
            <h1 className='text-2xl m-4 text-gray-800 text-center'>Products List</h1>
                    ...
                    products.map((product) => {
                        return (
                            <div className='bg-gray-100 shadow-md rounded-lg p-4 border-gray-500 mt-2 mx-3 border-2 w-96'>
                                <img className=' object-cover h-75 w-full rounded' src={product.image} alt={product.title} />
